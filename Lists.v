...
Theorem bag_theorem : forall n : nat, forall b : bag, count n (add n b) = S (count n b).
Proof.
  intros n b.
  induction b.
...
Theorem bag_count_sum : forall l1 l2 : bag, forall n : nat,
...
(* 0 since it's not possible to construct a value of the baz. *)
