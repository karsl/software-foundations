...
(* To show: If proposition P holds, then it's double negation doesn't hold.
   If P holds, then by defn. of negation, negation of P doesn't hold.
   If negation of P doesn't hold, then by defn. of negation, negation of
   negation of P hold. *)
...
(* To show: for any proposition, it's both true and false doesn't hold.
   By defn. of negation and conjuction P's conjuction with negation P is false (doesn't hold).
   By defn. of negation, negation of false is true. *)
...
Proof.
  ...
  - simpl.
    ...
    unfold tr_rev.
    simpl.
    assert (H: forall (A : Type) (l1 l2 : list A),
